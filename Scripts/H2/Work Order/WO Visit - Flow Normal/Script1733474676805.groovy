...
WebUI.selectOptionByValue(findTestObject('Work Order/select_Hubungan Pembawa dan Pemilik'), '', false)

WebUI.selectOptionByValue(findTestObject('Work Order/select_Alasan Datang ke AHASS'), '', false)

WebUI.click(findTestObject('Work Order/button_Simpan Data Pembawa'))

WebUI.verifyElementPresent(findTestObject('Work Order/popup_Data Pembawa'), 0)
...
WebUI.verifyElementPresent(findTestObject('Work Order/popup_Work Order'), 0)
